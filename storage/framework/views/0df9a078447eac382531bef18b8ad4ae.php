...
<head>
    ...
    <script src="<?php echo e(asset('js/sms-template.js')); ?>" defer></script>
...
<body class="<?php echo e(auth()->check() && auth()->user()->isAdmin() ? 'admin-ui' : ''); ?>">
    <script>
    ...
    <div class="content">
        ...
        <?php if(session('error')): ?>
            <div class="toast error show">
                ...
                <div class="toast-msg"><?php echo e(session('error')); ?></div>
            </div>
        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\lms\resources\views\layouts\sms.blade.php ENDPATH**/ ?>