...
<?php $__env->startSection('content'); ?>
    ...
    <section class="cc-hero">
        ...
        <div class="cc-body">
            ...
            <h3>Edit Enrollment — <?php echo e($enrollment->student->full_name ?? 'Student'); ?></h3>
            <p><?php echo e($enrollment->class->code ?? ''); ?> · <?php echo e($enrollment->class->course->name ?? $enrollment->class->course->title ?? ''); ?></p>
        </div>
        <span class="cc-status <?php echo e($currentStatus['cls']); ?>"><i class="fa-solid <?php echo e($currentStatus['icon']); ?>"></i> <?php echo e($currentStatus['label']); ?></span>
    </section>
    ...
    <div class="cc-card">
        ...
        <form method="POST" action="<?php echo e($formAction); ?>" id="editForm" data-dirty-warn="true">
            <?php echo csrf_field(); ?>
                ...
                <div class="cc-info-chips">
                    <span class="cc-chip">
                        ...
                        <span>
                            ...
                            <span class="cc-chip-value"><?php echo e($enrollment->student->full_name ?? '—'); ?></span>
                        </span>
                    </span>
                    <span class="cc-chip">
                        ...
                        <span>
                            ...
                            <span class="cc-chip-value"><?php echo e($enrollment->class->code ?? '—'); ?></span>
                        </span>
                    </span>
                    <span class="cc-chip">
                        ...
                        <span>
                            ...
                            <span class="cc-chip-value"><?php echo e($enrollment->class->course->name ?? $enrollment->class->course->title ?? '—'); ?></span>
                        </span>
                    </span>
                </div>
            </div>
                        ...
                        <div class="status-picker" role="radiogroup" aria-label="Enrollment status">
                            <?php $__currentLoopData = $statusMeta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="status-option">
                                    <input type="radio" name="status" value="<?php echo e($key); ?>" <?php echo e(old('status', $enrollment->status) === $key ? 'checked' : ''); ?>>
                                    <span class="status-card">
                                        <span class="st-icon <?php echo e($meta['cls']); ?>"><i class="fa-solid <?php echo e($meta['icon']); ?>"></i></span>
                                        <span class="status-card-body">
                                            <span class="status-card-title"><?php echo e($meta['label']); ?></span>
                                            <span class="status-card-sub"><?php echo e($meta['sub']); ?></span>
                                        </span>
                                    </span>
                                </label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cc-field full">
                        ...
                        <input type="number" name="final_grade" value="<?php echo e(old('final_grade', $enrollment->final_grade)); ?>" min="0" max="100" step="0.01" placeholder="e.g. 88.5">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cc-field full">
                        <label>Notes</label>
                        <textarea name="notes" rows="3" placeholder="Optional notes tungkol sa enrollment..." data-char-count="notesCount"><?php echo e(old('notes', $enrollment->notes)); ?></textarea>
...
<?php echo $__env->make('layouts.instructor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\instructor\enrollments\edit.blade.php ENDPATH**/ ?>