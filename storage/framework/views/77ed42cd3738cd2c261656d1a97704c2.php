...
<?php $__env->startSection('page-title-bar'); ?>
    <div class="page-title-bar">
        <h2 class="page-title">
            ...
            <?php echo e($course->code); ?> — Modules
        </h2>
    </div>
...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('instructor.courses.modules.reorder', $course)); ?>" id="reorderForm">
        <?php echo csrf_field(); ?>
    ...
    <div class="crud-card">
        <div class="crud-header">
            <h3>Course Modules (<?php echo e($modules->count()); ?>)</h3>
        ...
        <table class="crud-table" id="modulesTable">
            ...
            <tbody id="modulesTbody">
                <?php $__empty_1 = true; $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr data-id="<?php echo e($module->id); ?>">
                        <td><i class="fa-solid fa-grip-vertical drag-handle"></i></td>
                        <td class="order-num"><?php echo e($loop->iteration); ?></td>
                        <td>
                            <div class="module-row">
                                <i class="fa-solid fa-layer-group" style="color:#2563eb;"></i>
                                <div>
                                    <div style="font-weight:600;"><?php echo e($module->title); ?></div>
                                    <?php if($module->description): ?>
                                        <div style="font-size:0.78rem;color:#64748b;margin-top:2px;"><?php echo e(Str::limit($module->description, 80)); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </td>
                        <td><?php echo e($module->lessons->count() ?? 0); ?></td>
                        <td>
                            <form method="POST" action="<?php echo e(route('instructor.courses.modules.' . ($module->is_published ? 'unpublish' : 'publish'), [$course, $module])); ?>" style="display:inline;">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="publish-btn <?php echo e($module->is_published ? 'published' : 'draft'); ?>">
                                    <?php echo e($module->is_published ? 'Published' : 'Draft'); ?>
                        ...
                        <td class="actions-cell">
                            ...
                            <a href="<?php echo e(route('instructor.courses.modules.edit', [$course, $module])); ?>" class="btn-icon btn-edit" title="Edit">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            <form action="<?php echo e(route('instructor.courses.modules.destroy', [$course, $module])); ?>" method="POST" style="display:inline;">
                                <?php echo csrf_field(); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="6" style="text-align:center;padding:24px;color:#aaa;">
                            No modules yet. <a href="<?php echo e(route('instructor.courses.modules.create', $course)); ?>" style="color:#2563eb;text-decoration:underline;">Create the first module</a>
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
    ...
    <div style="margin: 24px;">
        <a href="<?php echo e(route('instructor.courses.show', $course)); ?>" class="btn-modal-cancel" style="display: inline-flex; align-items: center; justify-content: center; padding: 11px 32px; border-radius: 8px; font-size: 0.88rem; font-weight: 600; cursor: pointer; transition: background 0.2s; text-decoration: none;">
            ← Back to Course
        </a>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.instructor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\instructor\courses\modules\index.blade.php ENDPATH**/ ?>