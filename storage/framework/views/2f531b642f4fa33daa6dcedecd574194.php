...
<?php $__env->startSection('content'); ?>
    ...
    <section class="cc-hero">
        ...
        <div class="cc-body">
            ...
            <h3>New Discussion — <?php echo e($course->name ?? $course->title); ?></h3>
            <p><?php echo e($course->code); ?> · Start a conversation with your students</p>
        </div>
            ...
            <div class="cc-section">
                <div class="cc-grid">
                    <div class="cc-field full">
                        ...
                        <input type="text" name="title" value="<?php echo e(old('title')); ?>" required placeholder="e.g. Week 1: Introduce Yourself" maxlength="255" data-char-count="titleCount">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cc-field">
                        ...
                        <select name="type">
                            <?php $__currentLoopData = $discussionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="cc-section">
                ...
                <div class="cc-grid">
                    <div class="cc-field full">
                        ...
                        <textarea name="description" rows="4" placeholder="Discussion prompt para sa mga estudyante..." data-char-count="descCount"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.instructor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\instructor\courses\discussions\create.blade.php ENDPATH**/ ?>