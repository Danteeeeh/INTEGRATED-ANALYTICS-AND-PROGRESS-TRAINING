<?php $__env->startSection('title', 'Create Discussion'); ?>
<?php
    $activeNav = 'courses';
...
<?php $__env->startSection('content'); ?>
    <div class="form-card">
        ...
        <form method="POST" action="<?php echo e(route('admin.discussions.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="form-grid">
                <div class="form-field full">
                    <label>Title <span class="req">*</span></label>
                    <input type="text" name="title" required placeholder="Discussion title" value="<?php echo e(old('title')); ?>">
                ...
                <div class="form-field">
                    ...
                    <select name="type" required>
                        ...
                        <option value="qna" <?php echo e(old('type') == 'qna' ? 'selected' : ''); ?>>Q&amp;A</option>
                        <option value="graded" <?php echo e(old('type') == 'graded' ? 'selected' : ''); ?>>Graded</option>
                    </select>
                </div>
                ...
                <div class="form-field">
                    ...
                    <div style="display: flex; gap: 20px; padding: 10px 0;">
                        <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="is_pinned" value="1" <?php echo e(old('is_pinned') ? 'checked' : ''); ?> style="width: 18px; height: 18px;">
                            <span style="font-size: 0.88rem;">Pin this discussion</span>
                        </label>
                        <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="is_locked" value="1" <?php echo e(old('is_locked') ? 'checked' : ''); ?> style="width: 18px; height: 18px;">
                ...
                <div class="form-field full">
                    ...
                    <textarea name="content" rows="8" required placeholder="Write your discussion content here..."><?php echo e(old('content')); ?></textarea>
                    <span class="field-error"></span>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin-sms', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\admin\discussions\create.blade.php ENDPATH**/ ?>