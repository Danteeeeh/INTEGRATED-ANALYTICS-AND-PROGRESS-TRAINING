...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-page-header','data' => ['title' => 'Edit Announcement','subtitle' => 'Update announcement details and audience.','icon' => 'fa-bullhorn']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Announcement','subtitle' => 'Update announcement details and audience.','icon' => 'fa-bullhorn']); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('admin.announcements.show', $announcement)); ?>" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Back</a>
         <?php $__env->endSlot(); ?>
...
<?php endif; ?>
    ...
    <div class="user-panel">
        ...
        <div class="user-panel-body">
            <form action="<?php echo e(route('admin.announcements.update', $announcement)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-grid">
                    <div class="form-field full">
                        ...
                        <input type="text" name="title" value="<?php echo e(old('title', $announcement->title)); ?>" required placeholder="Announcement title">
                        <span class="field-error"><?php echo e($errors->first('title')); ?></span>
                    </div>

                    <div class="form-field full">
                        <label>Body <span class="required">*</span></label>
                        <textarea name="body" rows="6" required placeholder="Announcement message"><?php echo e(old('body', $announcement->body)); ?></textarea>
                    ...
                    <div class="form-field audience-field" data-audience="course">
                        ...
                        <select name="course_id">
                            ...
                            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($course->id); ?>" <?php if(old('course_id', $announcement->course_id) == $course->id): echo 'selected'; endif; ?>><?php echo e($course->code); ?> — <?php echo e($course->title); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="form-field audience-field" data-audience="class">
                        ...
                        <select name="class_id">
                            ...
                            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($class->id); ?>" <?php if(old('class_id', $announcement->class_id) == $class->id): echo 'selected'; endif; ?>><?php echo e($class->code); ?> — <?php echo e($class->course?->title); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="form-field audience-field" data-audience="role">
                        ...
                        <select name="target_role_id">
                            ...
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($role->id); ?>" <?php if(old('target_role_id', $announcement->target_role_id) == $role->id): echo 'selected'; endif; ?>><?php echo e($role->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="form-field">
                        ...
                        <input type="datetime-local" name="publish_at" value="<?php echo e(old('publish_at', $announcement->publish_at?->format('Y-m-d\TH:i'))); ?>">
                ...
                <div class="form-actions user-actions">
                    <a href="<?php echo e(route('admin.announcements.show', $announcement)); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\admin\announcements\edit.blade.php ENDPATH**/ ?>