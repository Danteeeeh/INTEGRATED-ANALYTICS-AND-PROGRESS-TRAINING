            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="first_name" name="first_name" value="<?php echo e(old('first_name')); ?>" required class="form-control">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="last_name" name="last_name" value="<?php echo e(old('last_name')); ?>" required class="form-control">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required class="form-control">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="identifier" name="identifier" value="<?php echo e(old('identifier')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="tel" id="phone" name="phone" value="<?php echo e(old('phone')); ?>" class="form-control">
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/admin/users/create.blade.php ENDPATH**/ ?>