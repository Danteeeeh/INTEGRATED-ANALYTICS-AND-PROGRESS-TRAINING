...
<?php $__env->startSection('content'); ?>
    ...
    <section class="cc-hero">
        ...
        <div class="cc-body">
            ...
            <h3>New Assignment — <?php echo e($course->name ?? $course->title); ?></h3>
            <p><?php echo e($course->code); ?> · Create a task for students to submit</p>
        </div>
            ...
            <div class="cc-section">
                <div class="cc-grid">
                    <div class="cc-field full">
                        ...
                        <input type="text" name="title" value="<?php echo e(old('title', request('title'))); ?>" required class="form-input" placeholder="e.g. Chapter 1 Exercise" maxlength="255" data-char-count="titleCount">
                    ...
                    <div class="cc-field">
                        ...
                        <select name="submission_type" required class="form-input">
                            <?php $__currentLoopData = $submissionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(old('submission_type') == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cc-field">
                        <label>Points</label>
                        <input type="number" name="points" value="<?php echo e(old('points', 100)); ?>" min="0" class="form-input">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="cc-field">
                        ...
                        <input type="datetime-local" name="due_date" value="<?php echo e(old('due_date')); ?>" class="form-input">
            ...
            <div class="cc-section">
                ...
                <div class="cc-grid">
                    <div class="cc-field full">
                        ...
                        <textarea name="instructions" rows="5" class="form-input" placeholder="Assignment instructions para sa mga estudyante..." data-char-count="instCount"><?php echo e(old('instructions')); ?></textarea>
...
<?php echo $__env->make('layouts.instructor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\instructor\courses\assignments\create.blade.php ENDPATH**/ ?>