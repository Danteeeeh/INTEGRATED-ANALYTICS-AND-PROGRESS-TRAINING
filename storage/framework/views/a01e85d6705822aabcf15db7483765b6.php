<?php $__env->startSection('title', 'Attempts — '.$quiz->title); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-page-header','data' => ['title' => 'Quiz Attempts','subtitle' => ''.e($quiz->title).' — '.e($course->title).'','icon' => 'fa-question-circle']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Quiz Attempts','subtitle' => ''.e($quiz->title).' — '.e($course->title).'','icon' => 'fa-question-circle']); ?>
         <?php $__env->slot('meta', null, []); ?> 
            <span class="user-status"><?php echo e($attempts->total()); ?> attempts</span>
         <?php $__env->endSlot(); ?>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $attempts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($attempt->student?->full_name ?? $attempt->student?->name ?? '—'); ?></td>
...
<?php endif; ?></td>
                                    <td>
                                        <div class="user-actions">
                                            <a href="<?php echo e(route('instructor.courses.quizzes.attempts.show', [$course, $quiz, $attempt])); ?>" class="btn btn-icon" title="Review"><i class="fa-solid fa-eye"></i></a>
                                        </div>
                                    </td>
                                </tr>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-empty-state','data' => ['icon' => 'fa-users','title' => 'No attempts yet','description' => 'Student attempts will appear here once the quiz is taken.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-users','title' => 'No attempts yet','description' => 'Student attempts will appear here once the quiz is taken.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <?php if($attempts->hasPages()): ?>
                <div class="pagination"><?php echo e($attempts->links()); ?></div>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.instructor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\instructor\courses\quizzes\attempts.blade.php ENDPATH**/ ?>