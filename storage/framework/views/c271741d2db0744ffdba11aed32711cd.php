<?php $__env->startSection('title', 'New Calendar Event'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-page-header','data' => ['title' => 'New Calendar Event','subtitle' => 'Schedule an event with type, visibility, and course context.','icon' => 'fa-calendar-plus']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'New Calendar Event','subtitle' => 'Schedule an event with type, visibility, and course context.','icon' => 'fa-calendar-plus']); ?>
...
<?php endif; ?>
    ...
    <div class="user-panel">
        ...
        <div class="user-panel-body">
            <form action="<?php echo e(route('admin.calendar.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>

                <div class="form-grid">
                    <div class="form-field full">
                        <label>Title <span class="required">*</span></label>
                        <input type="text" name="title" value="<?php echo e(old('title')); ?>" required placeholder="Event title">
                    ...
                    <div class="form-field">
                        ...
                        <select name="event_type" required>
                            <?php $__currentLoopData = ['assignment' => 'Assignment', 'quiz' => 'Quiz', 'virtual_class' => 'Virtual Class', 'exam' => 'Exam', 'announcement' => 'Announcement', 'course' => 'Course', 'personal' => 'Personal']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value); ?>" <?php if(old('event_type', 'exam') === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                    ...
                    <div class="form-field">
                        ...
                        <select name="visibility" required>
                            <?php $__currentLoopData = ['private' => 'Private', 'course' => 'Course', 'class' => 'Class', 'public' => 'Public']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value); ?>" <?php if(old('visibility', 'class') === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="form-field">
                        ...
                        <input type="datetime-local" name="end_at" value="<?php echo e(old('end_at')); ?>" required>
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" name="location" value="<?php echo e(old('location')); ?>" placeholder="Room, link, or venue">
                        <span class="field-error"><?php echo e($errors->first('location')); ?></span>
                    </div>

                    <div class="form-field full">
                        <label class="checkbox-label">
                            <input type="checkbox" name="is_all_day" value="1" <?php if(old('is_all_day')): echo 'checked'; endif; ?>>
                            All day event
                        </label>
                    </div>
                    ...
                    <div class="form-field full">
                        ...
                        <textarea name="description" rows="4" placeholder="Event description"><?php echo e(old('description')); ?></textarea>
                        <span class="field-error"><?php echo e($errors->first('description')); ?></span>
                    </div>
                </div>

                <div class="form-actions user-actions">
                    <a href="<?php echo e(route('admin.calendar.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\admin\calendar\create.blade.php ENDPATH**/ ?>