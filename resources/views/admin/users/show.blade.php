            ...
            <div class="profile-details">
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-grid">
                        <div class="detail-item">
                            <label>Role</label>
                            <span>{{ ucfirst($user->role->slug) }}</span>
                        </div>
                        <div class="detail-item">
                            <label>Status</label>
                    ...
                    <div class="detail-section">
                        ...
                        <div class="detail-grid">
                            <div class="detail-item">
                                ...
                                <span>{{ $user->enrolledClasses()->count() }}</span>
                            </div>
                            <div class="detail-item">
                                <label>Active Enrollments</label>
                                <span>{{ $user->enrollments()->active()->count() }}</span>
                            </div>
                            <div class="detail-item">
                                <label>Completed Courses</label>
                                <span>{{ $user->enrollments()->completed()->count() }}</span>
                            </div>
                        </div>
                    </div>
                @endif
                    ...
                    <div class="detail-section">
                        ...
                        <div class="detail-grid">
                            <div class="detail-item">
                                ...
                                <span>{{ $user->classesInstructing()->count() }}</span>
                            </div>
                            <div class="detail-item">
                                <label>Total Students</label>
                                <span>{{ $user->classesInstructing()->withCount('enrollments')->get()->sum('enrollments_count') }}</span>
                            </div>
                        </div>
                    </div>
                @endif
