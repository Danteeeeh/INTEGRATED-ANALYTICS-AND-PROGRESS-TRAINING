...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-page-header','data' => ['title' => 'Student Enrollments','subtitle' => 'Review enrollments in your classes.','icon' => 'fa-graduation-cap']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Student Enrollments','subtitle' => 'Review enrollments in your classes.','icon' => 'fa-graduation-cap']); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('instructor.enrollments.create')); ?>" class="btn btn-primary">
...
<?php endif; ?>
    ...
    <div class="user-panel">
        ...
        <form class="user-toolbar" method="GET" action="<?php echo e(route('instructor.enrollments.index')); ?>">
            <input class="form-control" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search students..." aria-label="Search enrollments">
            ...
            <a class="btn btn-secondary" href="<?php echo e(route('instructor.enrollments.index')); ?>">Clear</a>
        </form>
...
<?php endif; ?></td>
                                    ...
                                    <td>
                                        <div class="user-actions">
                                            <a href="<?php echo e(route('instructor.enrollments.show', $enrollment)); ?>" class="btn btn-icon" title="View"><i class="fa-solid fa-eye"></i></a>
                                            <a href="<?php echo e(route('instructor.enrollments.edit', $enrollment)); ?>" class="btn btn-icon" title="Edit"><i class="fa-solid fa-pen"></i></a>
                                            <form action="<?php echo e(route('instructor.enrollments.destroy', $enrollment)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to remove this enrollment?')">
                                                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-empty-state','data' => ['icon' => 'fa-user-plus','title' => 'No enrollments found','description' => 'No enrollments found in your classes.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-user-plus','title' => 'No enrollments found','description' => 'No enrollments found in your classes.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.instructor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\instructor\enrollments\index.blade.php ENDPATH**/ ?>