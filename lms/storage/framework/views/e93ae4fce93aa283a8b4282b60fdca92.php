<?php $__env->startSection('title', 'New Badge'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-page-header','data' => ['title' => 'New Badge','subtitle' => 'Define a badge and its award criteria.','icon' => 'fa-medal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'New Badge','subtitle' => 'Define a badge and its award criteria.','icon' => 'fa-medal']); ?>
            ...
            <form action="<?php echo e(route('admin.badges.store')); ?>" method="POST">
                ...
                <div class="form-grid">
                    <div class="form-field full">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" required placeholder="e.g. Perfect Attendance">
                    ...
                    <div class="form-field">
                        ...
                        <select name="badge_type" required>
                            <?php $__currentLoopData = ['course' => 'Course', 'competency' => 'Competency', 'achievement' => 'Achievement', 'participation' => 'Participation']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value); ?>" <?php if(old('badge_type', 'achievement') === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" name="icon" value="<?php echo e(old('icon', 'fa-award')); ?>" placeholder="e.g. fa-trophy">
                    ...
                    <div class="form-field full">
                        ...
                        <textarea name="criteria_description" rows="3" placeholder="How is this badge earned?"><?php echo e(old('criteria_description')); ?></textarea>
                        <span class="field-error"><?php echo e($errors->first('criteria_description')); ?></span>
                    </div>

                    <div class="form-field full">
                        <label>Description</label>
                        <textarea name="description" rows="3" placeholder="Badge description"><?php echo e(old('description')); ?></textarea>
                ...
                <div class="form-actions user-actions">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fa-solid fa-save"></i> Create Badge
                    </button>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\admin\badges\create.blade.php ENDPATH**/ ?>