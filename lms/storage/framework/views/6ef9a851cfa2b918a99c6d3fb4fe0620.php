...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-page-header','data' => ['title' => 'Edit Quiz','subtitle' => 'Update quiz settings, availability, and result rules.','icon' => 'fa-question-circle']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Quiz','subtitle' => 'Update quiz settings, availability, and result rules.','icon' => 'fa-question-circle']); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('admin.quizzes.show', $quiz)); ?>" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Back</a>
         <?php $__env->endSlot(); ?>
...
<?php endif; ?>
    ...
    <div class="user-panel">
        ...
        <div class="user-panel-body">
            <form action="<?php echo e(route('admin.quizzes.update', $quiz)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-field">
                        ...
                        <select name="class_id" required>
                            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($class->id); ?>" <?php if(old('class_id', $quiz->class_id) == $class->id): echo 'selected'; endif; ?>><?php echo e($class->code); ?> — <?php echo e($class->course?->title); ?></option>
                    ...
                    <div class="form-field full">
                        ...
                        <select name="result_visibility">
                            <?php $__currentLoopData = ['always' => 'Always', 'after_grading' => 'After grading', 'never' => 'Never']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="form-field full">
                        <div class="checkbox-grid">
                            <label class="checkbox-label">
                                <input type="checkbox" name="shuffle_questions" value="1" <?php if(old('shuffle_questions', $quiz->shuffle_questions)): echo 'checked'; endif; ?>>
                                Shuffle questions
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="shuffle_choices" value="1" <?php if(old('shuffle_choices', $quiz->shuffle_choices)): echo 'checked'; endif; ?>>
                                Shuffle choices
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="allow_navigation" value="1" <?php if(old('allow_navigation', $quiz->allow_navigation)): echo 'checked'; endif; ?>>
                                Allow navigation
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="auto_submit_on_timeout" value="1" <?php if(old('auto_submit_on_timeout', $quiz->auto_submit_on_timeout)): echo 'checked'; endif; ?>>
                                Auto-submit on timeout
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="review_allowed" value="1" <?php if(old('review_allowed', $quiz->review_allowed)): echo 'checked'; endif; ?>>
                                Allow review
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="show_correct_answers" value="1" <?php if(old('show_correct_answers', $quiz->show_correct_answers)): echo 'checked'; endif; ?>>
                ...
                <div class="form-actions user-actions">
                    <a href="<?php echo e(route('admin.quizzes.show', $quiz)); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\admin\quizzes\edit.blade.php ENDPATH**/ ?>