...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-page-header','data' => ['title' => 'My Enrollments','subtitle' => 'Your enrollment history and status.','icon' => 'fa-user-plus']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My Enrollments','subtitle' => 'Your enrollment history and status.','icon' => 'fa-user-plus']); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('student.classes.index')); ?>" class="btn btn-secondary"><i class="fa-solid fa-school"></i> Browse Classes</a>
         <?php $__env->endSlot(); ?>
                ...
                <div class="learning-card">
                    <div>
                        <div class="user-kicker">
                            <?php echo e($enrollment->class?->code ?? 'Class'); ?> · <?php echo e($enrollment->class?->academicPeriod?->name ?? ''); ?>

                        </div>
                        <h3><?php echo e($enrollment->class?->course?->title ?? 'Course'); ?></h3>
                        <p><?php echo e($enrollment->class?->instructor?->full_name ?? '—'); ?></p>
                    </div>
                    <div>
                        <?php if($enrollment->final_grade !== null): ?>
                            <div class="learning-progress"><span style="width: <?php echo e(min(100, (float) $enrollment->final_grade)); ?>%"></span></div>
                        <?php endif; ?>
...
<?php endif; ?>
                            <a href="<?php echo e(route('student.enrollments.show', $enrollment)); ?>" class="btn btn-secondary btn-sm"><i class="fa-solid fa-eye"></i> Details</a>
                        </div>
                    </div>
                </div>
        ...
        <?php if($enrollments->hasPages()): ?>
            <div class="pagination"><?php echo e($enrollments->links()); ?></div>
        <?php endif; ?>
    <?php else: ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-empty-state','data' => ['icon' => 'fa-user-plus','title' => 'No enrollments yet','description' => 'Browse available classes to enroll in your first course.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-user-plus','title' => 'No enrollments yet','description' => 'Browse available classes to enroll in your first course.']); ?>
             <?php $__env->slot('action', null, []); ?> 
                <a href="<?php echo e(route('student.classes.index')); ?>" class="btn btn-primary"><i class="fa-solid fa-school"></i> Browse Classes</a>
             <?php $__env->endSlot(); ?>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/student/enrollments/index.blade.php ENDPATH**/ ?>