<?php $__env->startSection('title', 'Class Portal'); ?>
...
<?php $__env->startSection('page-title-bar'); ?>
    <div class="page-title-bar">
        <h2 class="page-title"><i class="fa-solid fa-chalkboard-user"></i> <?php echo e($courseTitle); ?> · <?php echo e($class->code); ?></h2>
        <div class="page-actions">
            <a href="<?php echo e(route('student.classes.index')); ?>" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Back to classes</a>
        </div>
    </div>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="student-class-portal">
        <section class="class-hero" aria-labelledby="class-hero-title">
            ...
            <div>
                <h1 id="class-hero-title"><?php echo e($course?->title ?? $course?->name ?? 'Class Portal'); ?></h1>
                <p><?php echo e($class->code); ?> · <?php echo e($class->instructor?->full_name ?? 'Instructor not assigned'); ?> · <?php echo e($class->academicPeriod?->name ?? 'Academic period not specified'); ?></p>
            </div>
            <span class="hero-status <?php echo e($statusClass); ?>"><i class="fa-solid fa-circle"></i> <?php echo e(ucfirst($status)); ?></span>
        </section>
            ...
            <div>
                <section class="portal-card" aria-labelledby="overview-title">
                    ...
                    <div class="portal-card-body">
                        <dl class="meta-grid">
                            <div class="meta-row"><dt>Course code</dt><dd><?php echo e($course?->code ?? '—'); ?></dd></div>
                            <div class="meta-row"><dt>Class code</dt><dd><?php echo e($class->code); ?></dd></div>
                            <div class="meta-row"><dt>Instructor</dt><dd><?php echo e($class->instructor?->full_name ?? '—'); ?></dd></div>
                            <div class="meta-row"><dt>Schedule</dt><dd><?php echo e($class->schedule ?: 'Not specified'); ?></dd></div>
                            <div class="meta-row"><dt>Room</dt><dd><?php echo e($class->room ?: 'Not specified'); ?></dd></div>
                            <div class="meta-row"><dt>Enrollment</dt><dd><?php echo e($enrolledCount); ?><?php echo e($capacity ? ' / '.$capacity : ''); ?></dd></div>
                            <div class="meta-row"><dt>Credits</dt><dd><?php echo e($course?->credits ?? 'N/A'); ?></dd></div>
                            <div class="meta-row"><dt>Available seats</dt><dd><?php echo e($availableSeats ?? '—'); ?></dd></div>
                        </dl>
                        <?php if($course?->description): ?>
                            <div class="rich-copy"><strong>Course description</strong><br><?php echo e($course->description); ?></div>
                        <?php endif; ?>
                        <?php if($course?->objectives): ?>
                            <div class="rich-copy"><strong>Learning objectives</strong><br><?php echo e($course->objectives); ?></div>
                        <?php endif; ?>
                    </div>
                </section>

                <?php if($isEnrolled && $enrollment?->status === 'active'): ?>
                    <section class="portal-card" aria-labelledby="progress-title">
                        <div class="portal-card-head"><h3 id="progress-title"><i class="fa-solid fa-chart-line"></i> Your progress</h3><span><?php echo e(number_format($progress['overall'] ?? 0, 1)); ?>% overall</span></div>
                        <div class="portal-card-body">
                            <div class="progress-grid">
                                <?php $__currentLoopData = [
                                    ...
                                    <div class="progress-stat">
                                        <span class="progress-stat-label"><?php echo e($metric['label']); ?></span>
                                        <span class="progress-stat-value"><?php echo e($metric['count'] ?? false ? $metric['value'] : number_format($metric['value'], 1)); ?><?php echo e(($metric['grade'] ?? false) || !($metric['count'] ?? false) ? '%' : ''); ?></span>
                                        <?php if(!($metric['count'] ?? false)): ?>
                                            <div class="progress-track" role="progressbar" aria-label="<?php echo e($metric['label']); ?>" aria-valuemin="0" aria-valuemax="100" aria-valuenow="<?php echo e(min(100, max(0, $metric['value']))); ?>"><span style="width:<?php echo e(min(100, max(0, $metric['value']))); ?>%"></span></div>
                                        <?php endif; ?>
                                    </div>
                ...
                <section class="portal-card" aria-labelledby="activity-title">
                    ...
                    <div class="portal-card-body">
                        <?php if(isset($upcomingActivities) && $upcomingActivities->isNotEmpty()): ?>
                            <div class="activity-list">
                                <?php $__currentLoopData = $upcomingActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="activity-item">
                                        <i class="fa-solid <?php echo e($activity['type'] === 'Assignment' ? 'fa-file-pen' : ($activity['type'] === 'Quiz' ? 'fa-circle-question' : 'fa-video')); ?>" aria-hidden="true"></i>
                                        <div class="activity-copy"><strong><?php echo e($activity['title']); ?></strong><small><?php echo e($activity['type']); ?> · <?php echo e($activity['date']); ?></small></div>
                                        <?php if(!empty($activity['url'])): ?><a href="<?php echo e($activity['url']); ?>">Open <i class="fa-solid fa-arrow-right"></i></a><?php endif; ?>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php else: ?>
            ...
            <aside>
                <section class="portal-card" aria-labelledby="resources-title">
                    ...
                    <div class="portal-card-body">
                        <div class="resource-grid">
                            <a class="resource-card" href="<?php echo e(route('student.courses.show', $course)); ?>" aria-label="Open course overview"><span class="resource-icon"><i class="fa-solid fa-book-open"></i></span><span><strong>Course overview</strong><small>Modules and course details</small></span></a>
                            <a class="resource-card" href="<?php echo e(route('student.courses.assignments.index', $course)); ?>" aria-label="Open course assignments"><span class="resource-icon"><i class="fa-solid fa-file-pen"></i></span><span><strong>Assignments</strong><small>View and submit work</small></span></a>
                            <a class="resource-card" href="<?php echo e(route('student.courses.quizzes.index', $course)); ?>" aria-label="Open course quizzes"><span class="resource-icon"><i class="fa-solid fa-circle-question"></i></span><span><strong>Quizzes</strong><small>Check available quizzes</small></span></a>
                            <a class="resource-card" href="<?php echo e(route('student.classes.virtual_classes.index', $class)); ?>" aria-label="Open virtual classes"><span class="resource-icon"><i class="fa-solid fa-video"></i></span><span><strong>Virtual classes</strong><small>View live sessions</small></span></a>
                            <a class="resource-card" href="<?php echo e(route('student.courses.discussions.index', $course)); ?>" aria-label="Open course discussions"><span class="resource-icon"><i class="fa-solid fa-comments"></i></span><span><strong>Discussions</strong><small>Join the conversation</small></span></a>
                            <a class="resource-card" href="<?php echo e(route('student.classes.gradebook.index', $class)); ?>" aria-label="Open class gradebook"><span class="resource-icon"><i class="fa-solid fa-chart-bar"></i></span><span><strong>Gradebook</strong><small>Review released grades</small></span></a>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="portal-card-body">
                        <?php if(isset($announcements) && $announcements->isNotEmpty()): ?>
                            <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <article class="announcement-item"><strong><?php echo e($announcement->title); ?></strong><small><?php echo e($announcement->created_at?->format('M d, Y g:i A')); ?></small><p><?php echo e(Str::limit($announcement->content ?? $announcement->body ?? '', 150)); ?></p></article>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                ...
                <?php if($isEnrolled): ?>
                    <section class="portal-card" aria-labelledby="enrollment-title">
                        ...
                        <div class="portal-card-body">
                            <dl class="meta-grid">
                                <div class="meta-row"><dt>Status</dt><dd><span class="hero-status <?php echo e($statusClass); ?>"><?php echo e(ucfirst($enrollment->status)); ?></span></dd></div>
                                <div class="meta-row"><dt>Enrolled</dt><dd><?php echo e($enrollment->enrolled_at?->format('M d, Y') ?? '—'); ?></dd></div>
                                <?php if($enrollment->final_grade !== null): ?><div class="meta-row"><dt>Final grade</dt><dd><?php echo e($enrollment->final_grade); ?>%</dd></div><?php endif; ?>
                                <?php if($enrollment->completed_at): ?><div class="meta-row"><dt>Completed</dt><dd><?php echo e($enrollment->completed_at->format('M d, Y')); ?></dd></div><?php endif; ?>
                            </dl>
                        </div>
                    </section>
                <?php endif; ?>
        ...
        <div class="action-row">
            <?php if($isEnrolled && $enrollment?->status === 'active'): ?>
                <form action="<?php echo e(route('student.classes.drop', $class)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <?php elseif(!$isEnrolled && $class->is_active && !$isFull): ?>
                <form action="<?php echo e(route('student.classes.enroll', $class)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('student.classes.index')); ?>" class="btn btn-secondary">Back to classes</a>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\student\classes\show.blade.php ENDPATH**/ ?>