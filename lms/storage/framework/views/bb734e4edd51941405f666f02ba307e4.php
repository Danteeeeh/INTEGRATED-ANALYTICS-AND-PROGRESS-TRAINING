<?php $__env->startSection('title', 'Submissions — '.$assignment->title); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-page-header','data' => ['title' => 'Assignment Submissions','subtitle' => ''.e($assignment->title).' — '.e($course->title).'','icon' => 'fa-tasks']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Assignment Submissions','subtitle' => ''.e($assignment->title).' — '.e($course->title).'','icon' => 'fa-tasks']); ?>
         <?php $__env->slot('meta', null, []); ?> 
            <span class="user-status"><?php echo e($submissions->total()); ?> submissions</span>
         <?php $__env->endSlot(); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('instructor.courses.assignments.show', [$course, $assignment])); ?>" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Back</a>
         <?php $__env->endSlot(); ?>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <div class="user-name"><?php echo e($submission->student?->full_name ?? $submission->student?->name ?? '—'); ?></div>
                                        <div class="user-email"><?php echo e($submission->student?->email); ?></div>
                                    </td>
                                    <td><?php echo e($submission->submitted_at?->format('M j, Y g:i A') ?? $submission->created_at?->format('M j, Y g:i A')); ?></td>
...
<?php endif; ?></td>
                                    <td>
                                        <?php if($submission->grade): ?>
                                            <?php echo e(number_format($submission->grade->score_percent ?? 0, 1)); ?>%
                                        <?php else: ?>
                                            —
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <div class="user-actions">
                                            <a href="<?php echo e(route('instructor.courses.assignments.submissions.show', [$course, $assignment, $submission])); ?>" class="btn btn-icon" title="Review"><i class="fa-solid fa-eye"></i></a>
                                        </div>
                                    </td>
                                </tr>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-empty-state','data' => ['icon' => 'fa-tasks','title' => 'No submissions yet','description' => 'Student submissions will appear here once they are turned in.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-tasks','title' => 'No submissions yet','description' => 'Student submissions will appear here once they are turned in.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.instructor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\instructor\courses\assignments\submissions.blade.php ENDPATH**/ ?>