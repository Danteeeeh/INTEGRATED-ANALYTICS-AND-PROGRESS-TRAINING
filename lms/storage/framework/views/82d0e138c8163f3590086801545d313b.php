...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-page-header','data' => ['title' => ''.e($rubric->title).'','subtitle' => 'Rubric criteria, levels, and scoring.','icon' => 'fa-table-list']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($rubric->title).'','subtitle' => 'Rubric criteria, levels, and scoring.','icon' => 'fa-table-list']); ?>
...
<?php endif; ?>
         ...
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('admin.rubrics.edit', $rubric)); ?>" class="btn btn-primary"><i class="fa-solid fa-pen"></i> Edit</a>
            <a href="<?php echo e(route('admin.rubrics.index')); ?>" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Back</a>
         <?php $__env->endSlot(); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <div class="user-panel-body">
            <div class="form-grid">
                <div class="form-field">
                    <label>Course</label>
                    <div><?php echo e($rubric->course?->title ?? 'General'); ?></div>
                </div>
                <div class="form-field">
                    <label>Class</label>
...
<?php endif; ?></div>
                ...
                <div class="form-field">
                    ...
                    <div><?php echo e($rubric->creator?->name ?? '—'); ?></div>
                </div>
                    ...
                    <div class="user-panel" style="margin-bottom:12px">
                        ...
                        <div class="user-panel-body">
                            <?php if($criterion->description): ?>
                                <p class="user-email"><?php echo e($criterion->description); ?></p>
                            <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-empty-state','data' => ['icon' => 'fa-scale-balanced','title' => 'No criteria yet','description' => 'Edit this rubric to add scoring criteria and levels.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-scale-balanced','title' => 'No criteria yet','description' => 'Edit this rubric to add scoring criteria and levels.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <?php if($rubric->assignments->count() > 0): ?>
        <div class="user-panel">
            <div class="user-panel-head">
            ...
            <div class="user-panel-body">
                <div class="user-table-wrap">
                    <table class="table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $rubric->assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($assignment->title); ?></td>
                                    <td><?php echo e($assignment->class?->code ?? '—'); ?></td>
                                    <td><?php echo e($assignment->class?->course?->title ?? '—'); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
    ...
    <div class="user-actions">
        <form action="<?php echo e(route('admin.rubrics.destroy', $rubric)); ?>" method="POST" onsubmit="return confirm('Delete this rubric?')">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\admin\rubrics\show.blade.php ENDPATH**/ ?>