...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-page-header','data' => ['title' => ''.e($announcement->title).'','subtitle' => 'Announcement for '.e($course->title).'','icon' => 'fa-bullhorn']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($announcement->title).'','subtitle' => 'Announcement for '.e($course->title).'','icon' => 'fa-bullhorn']); ?>
...
<?php endif; ?>
         ...
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('instructor.courses.announcements.edit', [$course, $announcement])); ?>" class="btn btn-primary"><i class="fa-solid fa-pen"></i> Edit</a>
            <a href="<?php echo e(route('instructor.courses.announcements.index', $course)); ?>" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Back</a>
         <?php $__env->endSlot(); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <div class="user-panel-body">
            <div class="form-grid">
                <div class="form-field">
                    ...
                    <div><?php echo e(ucfirst($announcement->audience_type ?? 'course')); ?></div>
                    <?php if($announcement->class): ?>
...
<?php endif; ?></div>
    ...
    <div class="user-actions">
        <form action="<?php echo e(route('instructor.courses.announcements.destroy', [$course, $announcement])); ?>" method="POST" onsubmit="return confirm('Delete this announcement?')">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.instructor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views\instructor\courses\announcements\show.blade.php ENDPATH**/ ?>