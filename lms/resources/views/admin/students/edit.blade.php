...
@section('content')
    <div class="form-card enhanced-form">
        <div class="form-header">
            ...
            <p>Update the details for {{ $student->full_name }} below.</p>
        </div>
        
        <form action="{{ route('admin.students.update', $student) }}" method="POST" id="studentForm" class="enhanced-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-field">
                        ...
                        <input type="text" name="first_name" value="{{ $student->first_name }}" required placeholder="Enter first name" autocomplete="given-name">
                        <span class="field-error">{{ $errors->first('first_name') }}</span>
                    </div>
                    
                    <div class="form-field">
                        <label>Last Name <span class="required">*</span></label>
                        <input type="text" name="last_name" value="{{ $student->last_name }}" required placeholder="Enter last name" autocomplete="family-name">
                        <span class="field-error">{{ $errors->first('last_name') }}</span>
                    </div>
                    
                    <div class="form-field full">
                        <label>Email Address <span class="required">*</span></label>
                        <input type="email" name="email" value="{{ $student->email }}" required placeholder="student@example.com" autocomplete="email">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-field">
                        ...
                        <input type="tel" name="phone" value="{{ $student->phone }}" placeholder="09XXXXXXXXX" autocomplete="tel">
                        <span class="field-error">{{ $errors->first('phone') }}</span>
                    </div>
                    
                    <div class="form-field">
                        <label>Student ID</label>
                        <input type="text" name="identifier" value="{{ $student->identifier }}" placeholder="Student ID (optional)">
                        <span class="field-error">{{ $errors->first('identifier') }}</span>
                    </div>
                    
                    <div class="form-field full">
                        <label>Address</label>
                        <textarea name="address" rows="3" placeholder="Enter address (optional)">{{ $student->address }}</textarea>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-field">
                        ...
                        <span class="field-error">{{ $errors->first('role_id') }}</span>
                    </div>
            ...
            <div class="form-actions enhanced-actions">
                <a href="{{ route('admin.students.show', $student) }}" class="btn-modal-cancel">
