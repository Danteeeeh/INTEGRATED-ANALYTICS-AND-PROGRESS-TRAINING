        ...
        <form method="POST" action="{{ route('admin.discussions.update', $discussion) }}">
            ...
            <div class="form-grid">
                <div class="form-field full">
                    ...
                    <input type="text" name="title" required placeholder="Discussion title" value="{{ old('title', $discussion->title) }}">
                ...
                <div class="form-field">
                    ...
                    <select name="course_id">
                        ...
                        @foreach($courses ?? [] as $course)
                            <option value="{{ $course->id }}" {{ old('course_id', $discussion->course_id) == $course->id ? 'selected' : '' }}>
                ...
                <div class="form-field">
                    ...
                    <div style="display: flex; gap: 20px; padding: 10px 0;">
                        <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="is_pinned" value="1" {{ old('is_pinned', $discussion->is_pinned) ? 'checked' : '' }} style="width: 18px; height: 18px;">
                            <span style="font-size: 0.88rem;">Pin this discussion</span>
                        </label>
                        <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                            <input type="checkbox" name="is_locked" value="1" {{ old('is_locked', $discussion->is_locked) ? 'checked' : '' }} style="width: 18px; height: 18px;">
