...
@section('content')
    ...
    <section class="cc-hero">
        ...
        <div class="cc-body">
            ...
            <h3>New Announcement — {{ $course->name ?? $course->title }}</h3>
            <p>{{ $course->code }} · Ipaalam sa iyong mga estudyante</p>
        </div>
            ...
            <div class="cc-section">
                <div class="cc-grid">
                    <div class="cc-field full">
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" required placeholder="e.g. Reminder: Midterm next week" maxlength="255" data-char-count="titleCount">
            ...
            <div class="cc-section">
                ...
                <div class="cc-grid">
                    <div class="cc-field full">
                        ...
                        <textarea name="body" rows="5" required placeholder="Announcement content..." data-char-count="bodyCount">{{ old('body') }}</textarea>
