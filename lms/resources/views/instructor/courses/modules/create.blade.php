...
@section('content')
    ...
    <section class="cc-hero">
        ...
        <div class="cc-body">
            ...
            <h3>New Module — {{ $course->name ?? $course->title }}</h3>
            <p>{{ $course->code }} · Organize lessons into a logical learning unit</p>
        </div>
        <span class="cc-badge"><i class="fa-solid fa-layer-group"></i> {{ $course->modules->count() }} modules</span>
    </section>
            ...
            <div class="cc-section">
                <div class="cc-grid">
                    <div class="cc-field full">
                        ...
                        <input type="text" name="title" required placeholder="e.g. Introduction to Programming" value="{{ old('title') }}" maxlength="255" data-char-count="titleCount">
                    ...
                    <div class="cc-field">
                        <label>Order</label>
                        <input type="number" name="order" min="1" placeholder="e.g. 1" value="{{ old('order', ($modules->count() ?? 0) + 1) }}">
            ...
            <div class="cc-section">
                ...
                <div class="cc-grid">
                    <div class="cc-field full">
                        ...
                        <textarea name="description" rows="4" placeholder="Describe what students will learn in this module..." data-char-count="descCount">{{ old('description') }}</textarea>
                    ...
                    <div class="cc-field full">
                        ...
                        <textarea name="objectives" rows="3" placeholder="List the key learning objectives..." data-char-count="objCount">{{ old('objectives') }}</textarea>
