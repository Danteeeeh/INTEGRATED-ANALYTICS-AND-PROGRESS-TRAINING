...
@section('content')
    ...
    <section class="cc-hero">
        ...
        <div class="cc-body">
            ...
            <h3>New Quiz — {{ $course->name ?? $course->title }}</h3>
            <p>{{ $course->code }} · Set up a timed quiz for your students</p>
        </div>
            ...
            <div class="cc-section">
                <div class="cc-grid">
                    <div class="cc-field full">
                        ...
                        <input type="text" name="title" value="{{ old('title', request('title')) }}" required placeholder="e.g. Chapter 1 Quiz" maxlength="255" data-char-count="titleCount">
            ...
            <div class="cc-section">
                ...
                <div class="cc-grid">
                    <div class="cc-field">
                        ...
                        <input type="number" name="time_limit_minutes" value="{{ old('time_limit_minutes', 30) }}" min="1" class="form-input">
                    ...
                    <div class="cc-field">
                        ...
                        <input type="number" name="attempt_limit" value="{{ old('attempt_limit', 1) }}" min="1" class="form-input">
                    ...
                    <div class="cc-field">
                        ...
                        <input type="number" name="passing_score_percent" value="{{ old('passing_score_percent', 60) }}" min="0" max="100" class="form-input">
            ...
            <div class="cc-section">
                ...
                <div class="cc-grid">
                    <div class="cc-field full">
                        ...
                        <textarea name="description" rows="3" placeholder="Quiz description..." data-char-count="descCount">{{ old('description') }}</textarea>
